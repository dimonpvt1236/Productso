...
Admin::model('Dimonpvt\Productso\Models\PrsoProduct')->title('Товары')->display(function ()
{
...
//		FormItem::text('category_id', 'Category'),
		...
		FormItem::multiselect('categories', 'Категории')->model('Dimonpvt\Productso\Models\PrsoCategory')->display('name'),
